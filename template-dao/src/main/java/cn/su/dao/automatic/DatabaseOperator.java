...
//import cn.su.dao.util.SqlBuildHelper;
...
//    }
//
//    public DatabaseOperator(Class parameterClass, Class resultClass) {
//        this.parameterClass = parameterClass;
//        this.resultClass = resultClass;
//        sqlBuilder = new SqlBuilder(cn.su.dao.automatic.SqlBuildHelper.getClassTableName(resultClass));
//        sqlExecuteInterface = new SqlExecute();
//        resultHandlerInterface = new ResultHandler<>();
//    }
//
...
//        List<Map<String, Object>> result = sqlExecuteInterface.search(getSql());
